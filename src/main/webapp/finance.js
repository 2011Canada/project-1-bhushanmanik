   ...
   // e.preventDefault();
    try{
        ...
        for(let i =0; i< user.length;i++){
            ...
            <td><input type="submit" id="sub1" value="Approve" onclick="approveReimb(${user[i].reimb_id})"></td>
            <td><input type="submit" id="sub2" value="Deny" onclick="denyReimb(${user[i].reimb_id})"></td>
          </tr>`;
        }
document.getElementById('reimbursement').innerHTML=x;
        console.log(user);
    } catch( e) {
        console.log(e);
    }
